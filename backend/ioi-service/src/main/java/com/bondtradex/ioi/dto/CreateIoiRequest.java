...
public record CreateIoiRequest(
        ...
        @DecimalMin(value = "0.0000", message = "Target price cannot be negative")
        @Digits(integer = 15, fraction = 4, message = "Target price format is invalid")
        ...
        @FutureOrPresent(message = "Settlement date cannot be in the past")
        LocalDate settlementDate,

        @Size(max = 1000, message = "Client comment cannot exceed 1000 characters")
